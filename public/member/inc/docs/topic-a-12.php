    ...
    <div class="topic">
            ...
            <div class="col-12">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-1_1" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-1_2" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-1_3" class="custom-control-input">
                    ...
                    <div class="pl-4">
                        <div class="custom-control custom-control-inline custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a12-1_4" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a12-1_4">ศูนย์สัตว์ทดลองแห่งชาติ</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a12-1_5" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a12-1_5">บริษัท โนมูระ สยามอินเตอร์เนชั่นแนล</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a12-1_6" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-1_7" class="custom-control-input">
        ...
        <div class="row form-group">
            <div class="col-12">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_1" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_2" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_3" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_4" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_5" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_6" class="custom-control-input">
        ...
        <div class="row form-group">
            <div class="col-12">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-3_1" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-3_2" class="custom-control-input">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-3_3" class="custom-control-input">
