        ...
        <div class="row form-group">
            ...
            <div class="col-12">
                <div class="custom-control custom-control-inline custom-radio mb-3">
                    <input type="radio" id="rad-a20-1_1" name="rad-a20-1" class="custom-control-input">
                ...
                <div class="custom-control custom-control-inline custom-radio mb-3">
                    <input type="radio" id="rad-a20-1_2" name="rad-a20-1" class="custom-control-input">
                ...
                <div class="custom-control custom-control-inline custom-radio mb-3">
                    <input type="radio" id="rad-a20-1_3" name="rad-a20-1" class="custom-control-input">
                ...
                <div class="custom-control custom-control-inline custom-radio mb-3">
                    <input type="radio" id="rad-a20-1_4" name="rad-a20-1" class="custom-control-input">
