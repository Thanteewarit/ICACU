...
class CreatedocsController extends Controller
{
    ...
    public function create($id)
    {
        ...
        if($Protocol_docsCk){
            ...
            $Protocol_docs->protocol_number = CnumberS('ICACU',$Protocol_docsCk->protocol_number);
            $Protocol_docs->protocol_status = "1";
            $Protocol_docs->number_ver = "1";
            $Protocol_docs->number_run = "1";
            $Protocol_docs->protocol_type = $id;
            $Protocol_docs->save();
        }else{
            $StatusUser  = StatusUser::all();
            $Protocol_docs  =   new Protocol_docs;
            $Protocol_docs->users_id = Auth::user()->id ;
            $Protocol_docs->protocol_number = CnumberS('ICACU',"ICACU-".date("y")."-000000");
            $Protocol_docs->protocol_status = "1";
            $Protocol_docs->number_ver = "1";
            $Protocol_docs->number_run = "1";
            $Protocol_docs->protocol_type = $id;
    ...
    public function updateProtocol_opic01(Request $request)
    {
            $Protocol_opic01 = new Protocol_opic01;
            $Protocol_opic01->protocol_id    =  Session::get('protocol_id');
            $Protocol_opic01->animal_protocol_th    =  $request->animal_protocol_th;
            $Protocol_opic01->animal_protocol_en    =  $request->animal_protocol_en;
            $Protocol_opic01->project_proposal_th    =  $request->project_proposal_th;
            $Protocol_opic01->project_proposal_en    =  $request->project_proposal_en;
            $Protocol_opic01->save();

    }

    public function updateProtocol_opic02(Request $request)
    {
            ...
            for ($i = 0; $i < $sum; $i++) {
                ...
                if(!empty($request->protocol_01_02[$i])){
                    ...
                    if(!empty($_FILES['protocol_file02']["name"][$i])){
                        ...
                        $file_nameth    =date("YmdHis").Session::get('protocol_id')."$type";
    ...
    public function updateProtocol_opic03(Request $request)
    {
            $Protocol_opic03                    = new Protocol_opic03;
            $Protocol_opic03->protocol_id       = Session::get('protocol_id');
            $Protocol_opic03->Name_th           = $request->Name_th;
            $Protocol_opic03->Surname_th        = $request->Surname_th;
            $Protocol_opic03->Name_en           = $request->Name_en;
            $Protocol_opic03->Surname_en        = $request->Surname_en;
            $Protocol_opic03->position_th       = $request->position_th;
            $Protocol_opic03->position_en       = $request->position_en;
            $Protocol_opic03->address_th        = $request->address_th;
            $Protocol_opic03->address_en        = $request->address_en;
            $Protocol_opic03->Tel               = $request->Tel;
            $Protocol_opic03->Fax               = $request->Fax;
            $Protocol_opic03->email             = $request->email;
            $Protocol_opic03->save();
    }

    public function updateProtocol_opic04(Request $request)
    {
    ...
    public function updateProtocol_opic05(Request $request)
    {
    ...
    public function updateProtocol_opic06(Request $request)
    {
        ...
        // $Protocol_opic06 = Protocol_opic06::where('protocol_id', Session::get('protocol_id'))
        // ->update([
        //         'Executive' => $request->Executive
        // ]);
    }

    public function updateProtocol_opic07(Request $request)
    {
    ...
    public function updateProtocol_opic08(Request $request)
    {
    ...
    public function updateProtocol_opic09(Request $request)
    {
    ...
    public function updateProtocol_opic10(Request $request)
    {
    ...
    public function updateProtocol_opic11(Request $request)
    {
    ...
    public function updateProtocol_opic12(Request $request)
    {
    ...
    public function updateProtocol_opic13(Request $request)
    {
    ...
    public function updateProtocol_opic14(Request $request)
    {
    ...
    public function updateProtocol_opic15(Request $request)
    {
    ...
    public function updateProtocol_opic16(Request $request)
    {
    ...
    public function updateProtocol_opic17(Request $request)
    {
    ...
    public function updateProtocol_opic18(Request $request)
    {
        if(!empty($_FILES['ptc18_file']["name"])){
                        
            $file_name  = $_FILES['ptc18_file']["name"];
            $file_tmp   = $_FILES['ptc18_file']["tmp_name"];
            $type       = $_FILES['ptc18_file']["type"];
            $type       = strrchr($file_name,".");
            $file_nameth    =date("YmdHis").Session::get('protocol_id')."$type";
            copy($file_tmp, "file-upload/".$file_nameth);
        }
    ...
    public function updateProtocol_opic19(Request $request)
    {
    ...
    public function updateProtocol_opic20(Request $request)
    {
    ...
    public function updateProtocol_opic21(Request $request)
    {
    ...
    public function updateProtocol_opic22(Request $request)
    {
    ...
    public function updateProtocol_opic23(Request $request)
    {
    ...
    public function updateProtocol_opic24(Request $request)
    {
    ...
    public function updateProtocol_opic25(Request $request)
    {
    ...
    public function updateProtocol_opic26(Request $request)
    {
    ...
    public function updateProtocol_opic27(Request $request)
    {
    ...
    public function updateProtocol_opic28(Request $request)
    {
    ...
    public function updateProtocol_opic30(Request $request)
    {
        //dd($request);
