...
class PdfController extends Controller
{
    public function staffPdf($id){
        ...
        $Protocol_opic02_30    =   Protocol_opic02::where('protocol_id',$id)->where('opic02_responsible','01')->first();
        ...
        //dd($Protocol_opic07);
        $pdf = PDF::loadView('admin.demopdf',compact(
            'Protocol_docs',
            'Protocol_opic01',
            'Protocol_opic02',
            'Protocol_opic02_30',
            ...
            return $pdf->stream($Protocol_docs->protocol_number.'.pdf');		
