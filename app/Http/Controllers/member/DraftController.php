...
class DraftController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('member.protocol-docs-draft',compact(
            'Protocol_docs',
            'Protocol_opic01',
            'Protocol_opic02',
            'Protocol_opic02_sub',
    ...
    {
        $Protocol_docs      =   Protocol_docs::where('id',$id)->delete();
        $Protocol_opic01    =   Protocol_opic01::where('protocol_id',$id)->delete();
        $Protocol_opic02    =   Protocol_opic02::where('protocol_id',$id)->delete();
        $Protocol_opic02_sub        =   Protocol_opic02_sub::where('protocol_id',$id)->delete();
        $Protocol_opic02_sub02      =   Protocol_opic02_sub02::where('protocol_id',$id)->delete();
        $Protocol_opic03    =   Protocol_opic03::where('protocol_id',$id)->delete();
        $Protocol_opic04    =   Protocol_opic04::where('protocol_id',$id)->delete();
        $Protocol_opic05    =   Protocol_opic05::where('protocol_id',$id)->delete();
        $Protocol_opic06    =   Protocol_opic06::where('protocol_id',$id)->delete();
        $Protocol_opic07    =   Protocol_opic07::where('protocol_id',$id)->delete();
        $Protocol_opic08    =   Protocol_opic08::where('protocol_id',$id)->delete();
        $Protocol_opic09    =   Protocol_opic09::where('protocol_id',$id)->delete();
        $Protocol_opic10    =   Protocol_opic10::where('protocol_id',$id)->delete();
        $Protocol_opic11    =   Protocol_opic11::where('protocol_id',$id)->delete();
        $Protocol_opic11_sub    =   Protocol_opic11_sub::where('protocol_id',$id)->delete();
        $Protocol_opic12    =   Protocol_opic12::where('protocol_id',$id)->delete();
        $Protocol_opic13    =   Protocol_opic13::where('protocol_id',$id)->delete();
        $Protocol_opic14    =   Protocol_opic14::where('protocol_id',$id)->delete();
        $Protocol_opic15    =   Protocol_opic15::where('protocol_id',$id)->delete();
        $Protocol_opic16    =   Protocol_opic16::where('protocol_id',$id)->delete();
        $Protocol_opic17    =   Protocol_opic17::where('protocol_id',$id)->delete();
        $Protocol_opic18    =   Protocol_opic18::where('protocol_id',$id)->delete();
        $Protocol_opic18_sub01  =   Protocol_opic18_sub01::where('protocol_id',$id)->delete();
        $Protocol_opic18_sub02  =   Protocol_opic18_sub02::where('protocol_id',$id)->delete();
        $Protocol_opic18_sub03  =   Protocol_opic18_sub03::where('protocol_id',$id)->delete();
        $Protocol_opic18_sub04  =   Protocol_opic18_sub04::where('protocol_id',$id)->delete();
        $Protocol_opic18_sub05  =   Protocol_opic18_sub05::where('protocol_id',$id)->delete();
        $Protocol_opic18_sub06  =   Protocol_opic18_sub06::where('protocol_id',$id)->delete();
        $Protocol_opic19    =   Protocol_opic19::where('protocol_id',$id)->delete();
        $Protocol_opic20    =   Protocol_opic20::where('protocol_id',$id)->delete();
        $Protocol_opic21    =   Protocol_opic21::where('protocol_id',$id)->delete();
        $Protocol_opic22    =   Protocol_opic22::where('protocol_id',$id)->delete();
        $Protocol_opic23    =   Protocol_opic23::where('protocol_id',$id)->delete();
        $Protocol_opic24    =   Protocol_opic24::where('protocol_id',$id)->delete();
        $Protocol_opic25    =   Protocol_opic25::where('protocol_id',$id)->delete();
        $Protocol_opic26    =   Protocol_opic26::where('protocol_id',$id)->delete();
        $Protocol_opic27    =   Protocol_opic27::where('protocol_id',$id)->delete();
        $Protocol_opic28    =   Protocol_opic28::where('protocol_id',$id)->delete();
        $Protocol_opic30    =   Protocol_opic30::where('protocol_id',$id)->delete();
        $Protocol_opic30_sub01    =   Protocol_opic30_sub01::where('protocol_id',$id)->delete();
        $Protocol_opic30_sub02    =   Protocol_opic30_sub02::where('protocol_id',$id)->delete();
        $Protocol_docsfile    =   Protocol_docsfile::where('protocol_id',$id)->delete();

        return redirect()->route('member.protocol_draft.index')->with('yes', 'สำเร็จ'); 
    }
