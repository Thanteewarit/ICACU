...
<head>
    <meta charset="utf-8">
	<title>Comming soon - Gradient Able files Admin Template by Codedthemes</title>
	<meta name="description" content="Comming soon page - Gradient Able">
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="author" content="Codedthemes">
    <!-- Favicon -->
    {{-- <link rel="shortcut icon" type="text/css" href="{{URL::asset('files/extra-pages/comming-soon/img/favicon.ico')}}"> --}}
	<link rel="stylesheet" href="{{URL::asset('files/extra-pages/comming-soon/css/style-v2.css')}}">
    <!-- Modernizr runs quickly on page load for detecting features -->
    <script src="{{URL::asset('files/extra-pages/comming-soon/js/modernizr.custom.js')}}"></script>
</head>
...
<body>
            ...
            <div class="sl-slide bg-1" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
                <div class="sl-slide-inner">
                    <div class="content-slide">
                        <div class="container">
                            <img  src="{{URL::asset('files/extra-pages/comming-soon/img/logo.png')}}" alt="" class="brand-logo text-intro opacity-0" />
                            ...
                            <div class="portfolio my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                                ...
                                <figure class="col-xs-12 col-sm-12 col-md-6 col-lg-4 annex-img split-section" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="img/gallery-1.jpg" class="gallery-link small" data-image="img/gallery-1.jpg" itemprop="contentUrl" data-size="1920x1280">
                                        <img  src="{{URL::asset('files/extra-pages/comming-soon/img/gallery-1.jpg')}}" itemprop="thumbnail" alt="This is my work" class="img-responsive gallery-img small-square" />
                                    </a>
                                ...
                                <figure class="col-xs-12 col-sm-12 col-md-6 col-lg-4 annex-img split-section" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="img/gallery-2.jpg" class="gallery-link small" data-image="img/gallery-2.jpg" itemprop="contentUrl" data-size="1920x1280">
                                        <img  src="{{URL::asset('files/extra-pages/comming-soon/img/gallery-2.jpg')}}" itemprop="thumbnail" alt="This is my work" class="img-responsive gallery-img small-square" />
                                    </a>
                                    <figcaption itemprop="caption description">
                                        <div class="photo-details">
                                ...
                                <figure class="col-xs-12 col-sm-12 col-md-6 col-lg-4 annex-img split-section" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="img/gallery-3.jpg" class="gallery-link small" data-image="img/gallery-3.jpg" itemprop="contentUrl" data-size="1920x1280">
                                        <img src="{{URL::asset('files/extra-pages/comming-soon/img/gallery-3.jpg')}}" itemprop="thumbnail" alt="This is my work" class="img-responsive gallery-img small-square" />
                                    </a>
                                    <figcaption itemprop="caption description">
                                        <div class="photo-details">
                                ...
                                <figure class="col-xs-12 col-sm-12 col-md-6 col-lg-4 annex-img split-section" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="img/gallery-4.jpg" class="gallery-link small" data-image="img/gallery-4.jpg" itemprop="contentUrl" data-size="1920x1280">
                                        <img src="{{URL::asset('files/extra-pages/comming-soon/img/gallery-4.jpg')}}" itemprop="thumbnail" alt="This is my work" class="img-responsive gallery-img small-square" />
                                    </a>
                                    <figcaption itemprop="caption description">
                                        <div class="photo-details">
                                ...
                                <figure class="col-xs-12 col-sm-12 col-md-6 col-lg-4 annex-img split-section" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="img/gallery-5.jpg" class="gallery-link small" data-image="img/gallery-5.jpg" itemprop="contentUrl" data-size="1920x1280">
                                        <img  src="{{URL::asset('files/extra-pages/comming-soon/img/gallery-5.jpg')}}" itemprop="thumbnail" alt="This is my work" class="img-responsive gallery-img small-square" />
                                    </a>
                                    <figcaption itemprop="caption description">
                                        <div class="photo-details">
                                ...
                                <figure class="col-xs-12 col-sm-12 col-md-6 col-lg-4 annex-img split-section" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                    <a href="img/gallery-6.jpg" class="gallery-link small" data-image="img/gallery-6.jpg" itemprop="contentUrl" data-size="1920x1280">
                                        <img  src="{{URL::asset('files/extra-pages/comming-soon/img/gallery-6.jpg')}}" itemprop="thumbnail" alt="This is my work" class="img-responsive gallery-img small-square" />
                                    </a>
                                    <figcaption itemprop="caption description">
                                        <div class="photo-details">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-5 info-contact">
                                    ...
                                    <p class="list-info">
                                        ...
                                        <br>
                                        <i class="icon ion-ios-email"></i> Email : <a href="mailto:your-email@example.com" class="phone-mail-link">dumy@example.com</a>
                                        <br>
    ...
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/jquery.min.js')}}"></script>
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/jquery.easings.min.js')}}"></script>
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/bootstrap.min.js')}}"></script>
    <!-- SlitSlider plugin -->
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/jquery.ba-cond.min.js')}}"></script>
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/jquery.slitslider.js')}}"></script>
    <!-- Newsletter plugin -->
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/notifyMe.js')}}"></script>
    <!-- Contact form plugin -->
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/contact-me.js')}}"></script>
    <!-- Popup Newsletter Form -->
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/classie.js')}}"></script>
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/dialogFx.js')}}"></script>
    <!-- PhotoSwipe Core JS file -->
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/photoswipe.js')}}"></script>
    <!-- PhotoSwipe UI JS file -->
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/photoswipe-ui-default.js')}}"></script>
    <!-- Custom Scrollbar plugin -->
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/jquery.mCustomScrollbar.js')}}"></script>
    <!-- Countdown plugin -->
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/jquery.countdown.js')}}"></script>
    <script>
    $("#countdown")
    ...
    <script  src="{{URL::asset('files/extra-pages/comming-soon/js/main.js')}}"></script>
</body>
