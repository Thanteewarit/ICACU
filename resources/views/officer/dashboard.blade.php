        ...
        <div class="px-4">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="card mb-4">
                    <div class="card-body">
                        <h5 class="card-title">{{ $r->animal_protocol_th }}</h5>
                        <p class="card-text">{{ $r->project_proposal_th }}</p>
                    <a href="{{ route('officer.protocol_list.index')}}"  class="btn btn-danger" title="{{ $r->StatusTodo  }}">{{$r->StatusTodo}}</a>
                    </div>
                    </div>
                </div>
                @endforeach
