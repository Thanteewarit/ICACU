        ...
        @hasanyrole('committee|secretary|reviewer')
            ...
            @else
                @role('reviewer')
                        ...
                        <textarea class="form-control form-control-sm auto-expand Merge03" rows="4" name="comment" placeholder="กรุณาระบุเหตผล.." @role('secretary') readonly @endrole></textarea>
                        </div>
                @endrole
            @endif
        @endhasanyrole
