<div class="work-pane group-ptc tab-content">
    ...
    <div id="group_pend" aria-labelledby="tab_pend" role="tabpanel" class="tab-pane fade show active">
        <div class="work-tab text-center">
            <nav class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <a id="tab_ed" href="#con_rv" aria-controls="con_rv" class="nav-item nav-link" data-toggle="tab" role="tab" aria-selected="false">Waiting</a>
                <a id="con_rs" href="#con_rv2" aria-controls="con_rv2" class="nav-item nav-link" data-toggle="tab" role="tab" aria-selected="false">Review</a>
            </nav>
        </div>
        <div class="work-con tab-content" id="nav-tabContent">
            <div id="con_sm" aria-labelledby="tab_sm" role="tabpanel" class="tab-pane fade show active">
                @include ('member.inc-view.list.status-submitted')
            </div>
            <div id="con_rv" aria-labelledby="tab_ed" role="tabpanel" class="tab-pane fade">
                @include ('member.inc-view.list.status-waiting')
            </div>
            <div id="con_rv2" aria-labelledby="con_rs" role="tabpanel" class="tab-pane fade">
                @include ('member.inc-view.list.status-review')
            </div>
        </div>
    </div>
    ...
    <div id="group_progess" aria-labelledby="tab_progess" role="tabpanel" class="tab-pane fade">
        ...
        <div class="work-con tab-content" id="nav-tabContent">
            <div id="con_ap" aria-labelledby="tab_ap" role="tabpanel" class="tab-pane fade show active">
                @include ('member.inc-view.list.status-progress')
            </div>
        </div>
    </div>
