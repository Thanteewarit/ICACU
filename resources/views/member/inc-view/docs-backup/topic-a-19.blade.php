        ...
        <div class="row form-group">
            <div class="col-12">
                <div class="custom-control custom-control-inline custom-radio mb-1">
                    <input type="radio" id="rad-a19-1_1" name="rad-a19-1" class="custom-control-input">
                    <label class="custom-control-label" for="rad-a19-1_1">ไม่มี (No)</label>
                </div>
                <div class="custom-control custom-control-inline custom-radio mb-1">
                    <input type="radio" id="rad-a19-1_2" name="rad-a19-1" class="custom-control-input">
        ...
        <div class="row form-group">
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a19-1_1" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a19-1_1">Minor Surgery</label>
                        </div>
                    </div>
                    <div class="col">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a19-1_2" class="custom-control-input">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a19-1_3" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a19-1_3">Survival Surgery</label>
                        </div>
                    </div>
                    <div class="col">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a19-1_4" class="custom-control-input">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a19-1_5" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a19-1_5">Single Surgery</label>
                        </div>
                    </div>
                    <div class="col">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a19-1_6" class="custom-control-input">
