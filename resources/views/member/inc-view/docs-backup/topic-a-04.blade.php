    ...
    <div class="topic">
        ...
        <div class="row">
            <div class="col-12">
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a4-1_1" class="custom-control-input">
            ...
            <div class="col-12">
                <div class="custom-control custom-checkbox custom-control-inline mb-1 ml-4">
                    <input type="checkbox" id="chk-a4-1_2" class="custom-control-input">
                    <label class="custom-control-label" for="chk-a4-1_2"><strong>งานวิจัยทั่วไป (General reseach)</strong></label>
                </div>
                <div class="custom-control custom-checkbox custom-control-inline mb-1 ml-4">
                    <input type="checkbox" id="chk-a4-1_3" class="custom-control-input">
        ...
        <div class="row form-group pl-4">
            <div class="col-md-12">
                <hr>
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a4-1_4" class="custom-control-input">
            ...
            <div class="col-md-12">
                <hr>
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a4-1_15" class="custom-control-input">
        ...
        <div class="row form-group">
            <div class="col-12">
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a4-2_1" class="custom-control-input">
        ...
        <div class="row form-group">
            <div class="col-12">
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a4-3_1" class="custom-control-input">
            ...
            <div class="col-md-12">
                <div class="row pl-4">
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a4-3_2" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a4-3_2">วัคซีน (Vaccine)</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a4-3_3" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a4-3_3">เอ็นไซม์(Enzymes)</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a4-3_4" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a4-3_4">แอนติบอดี (Antibodies)</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a4-3_5" class="custom-control-input">
                            <label class="custom-control-label" for="chk-a4-3_5">คอมพลีเมนท์(Complement)</label>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a4-3_6" class="custom-control-input">
        ...
        <div class="row form-group">
            <div class="col-12">
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a4-4_1" class="custom-control-input">
        ...
        <div class="row form-group">
            <div class="col-12">
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a4-5_1" class="custom-control-input">
