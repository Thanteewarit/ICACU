    ...
    <form class="box-topic">
        <div class="topic">
            ...
            <div class="row form-group">
                <div class="col-12">
                    <div class="custom-control custom-control-inline custom-radio">
                        <input type="radio" id="rad-tmn-1_1" name="rad-tmn-1" class="custom-control-input">
            ...
            <div class="row form-group">
                <div class="col-12">
                    <div class="custom-control custom-control-inline custom-radio">
                        <input type="radio" id="rad-tmn-1_2" name="rad-tmn-1" class="custom-control-input">
            ...
            <div class="row form-group">
                <div class="col-12">
                    <div class="custom-control custom-control-inline custom-radio">
                        <input type="radio" id="rad-tmn-1_3" name="rad-tmn-1" class="custom-control-input">
            ...
            <div class="row form-group">
                <div class="col-12">
                    <div class="custom-control custom-control-inline custom-radio">
                        <input type="radio" id="rad-tmn-1_4" name="rad-tmn-1" class="custom-control-input">
