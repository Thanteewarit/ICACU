        ...
        <div class="row form-group">
            <div class="col-12">
                <div class="custom-control custom-control-inline custom-radio mb-1">
                    <input type="radio" id="rad-a22-1_1" name="ptc22_01" value="N" checked class="custom-control-input">
                    <label class="custom-control-label" for="rad-a22-1_1">ไม่มี (No)</label>
                </div>
                <div class="custom-control custom-control-inline custom-radio mb-1">
                    <input type="radio" id="rad-a22-1_2" name="ptc22_01" value="Y"   class="custom-control-input">
