    ...
    <div class="topic">
        ...
        <div class="row form-group">
            <div class="col-12">
                ...
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a15-1_1" class="custom-control-input" name="ptc15_01" value="Y">
                ...
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a15-1_2" class="custom-control-input" name="ptc15_02" value="Y">
                    <label class="custom-control-label" for="chk-a15-1_2">หน่วยงานอื่นๆ โปรดระบุ (Other, please specify)</label>
                </div>
                <input type="text" class="form-control form-control-sm" name="ptc15_02_sub">
        ...
        <div class="row form-group">
            <div class="col-12">
                ...
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a15-2_1" class="custom-control-input" name="ptc15_03" value="Y">
                ...
                <div class="custom-control custom-checkbox mb-1">
                    <input type="checkbox" id="chk-a15-2_2" class="custom-control-input" name="ptc15_04" value="Y">
