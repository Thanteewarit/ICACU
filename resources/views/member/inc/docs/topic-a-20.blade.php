    ...
    <div class="topic">
        ...
        <div class="row form-group">
            ...
            <div class="col-12">
                <div class="custom-control custom-control-inline custom-radio mb-3">
                    <input type="radio" id="rad-a20-1_1" name="ptc20_01" value="B" class="custom-control-input">
        ...
        <div class="row form-group">
            <div class="col-12">
                ...
                <textarea class="form-control form-control-sm" name="ptc20_02" rows="6" required></textarea>
            </div>
        </div>
