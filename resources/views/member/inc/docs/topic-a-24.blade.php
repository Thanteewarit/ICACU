        ...
        <div class="row form-group">
            <div class="col-12">
                <div class="custom-control custom-radio mb-1">
                    <input type="radio" id="rad-a24-1_1" name="ptc24_01" value="Y" class="custom-control-input">
                    <label class="custom-control-label" for="rad-a24-1_1">ทำให้สัตว์ตายอย่างสงบ (Euthanasia)</label>
                </div>
                <div class="custom-control custom-radio mb-1">
                    <input type="radio" id="rad-a24-1_2" name="ptc24_02"  value="Y" class="custom-control-input">
                    <label class="custom-control-label" for="rad-a24-1_2">นำสัตว์ไปใช้ในโครงการอื่น (Transfer to another research project)</label>
                </div>
                <textarea class="form-control form-control-sm ml-4 mb-4" name="ptc24_03" rows="3" ></textarea>
                <div class="custom-control custom-radio mb-1">
                    <input type="radio" id="rad-a24-1_3" name="ptc24_04" value="Y" class="custom-control-input">
                    <label class="custom-control-label" for="rad-a24-1_3">อื่นๆ (ระบุวิธีการพร้อมเหตุผล) (Other, please specify method and why)</label>
                </div>
                <textarea class="form-control form-control-sm ml-4 mb-4" name="ptc24_05" rows="3" ></textarea>
            </div>
        </div>
