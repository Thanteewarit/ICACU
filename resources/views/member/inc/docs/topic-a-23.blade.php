    ...
    <div class="topic">
        ...
        <div class="row form-group">
            <div class="col-12 mb-4">
                ...
                <textarea class="form-control form-control-sm" name="ptc23_01" rows="3" required></textarea>
            </div>
            <div class="col-12 mb-4">
                ...
                <textarea class="form-control form-control-sm" name="ptc23_02" rows="3" required></textarea>
            </div>
            <div class="col-12 mb-4">
                ...
                <textarea class="form-control form-control-sm" name="ptc23_03" rows="3" required></textarea>
            </div>
            <div class="col-12 mb-4">
                ...
                <textarea class="form-control form-control-sm" name="ptc23_04" rows="3" required></textarea>
            </div>
        </div>
