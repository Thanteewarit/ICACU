    ...
    <div class="topic">
            ...
            <div class="col-12">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-1_1" class="custom-control-input" name="ptc12_01" value="Y">
                    ...
                    <input type="text" class="form-control form-control-sm mb-3" name="ptc12_01_sub"  value=" "  >
                </div>
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-1_2" class="custom-control-input" name="ptc12_02" value="Y">
                    ...
                    <input type="text" class="form-control form-control-sm mb-3" name="ptc12_02_sub" value=" " >
                </div>
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-1_3" class="custom-control-input" name="ptc12_03" value="Y">
                    ...
                    <div class="pl-4">
                        <div class="custom-control custom-control-inline custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a12-1_4" class="custom-control-input" name="ptc12_03_sub_01" value="Y">
                            <label class="custom-control-label" for="chk-a12-1_4">ศูนย์สัตว์ทดลองแห่งชาติ</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a12-1_5" class="custom-control-input" name="ptc12_03_sub_02" value="Y">
                            <label class="custom-control-label" for="chk-a12-1_5">บริษัท โนมูระ สยามอินเตอร์เนชั่นแนล</label>
                        </div>
                        <div class="custom-control custom-control-inline custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a12-1_6" class="custom-control-input" name="ptc12_03_sub_03" value="Y">
                            <label class="custom-control-label" for="chk-a12-1_6">อื่นๆ โปรดระบุ<label>
                        </div>
                        <input type="text" class="form-control form-control-sm mb-3" name="ptc12_03_sub_04" value=" "  >
                    </div>
                </div>
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-1_7" class="custom-control-input" name="ptc12_04" value="Y">
                        <label class="custom-control-label" for="chk-a12-1_7">อื่นๆ ระบุ (Other, please specify)</label>
                    </div>
                    <input type="text" class="form-control form-control-sm mb-3" name="ptc12_03_sub" value=" "  >
                </div>
                <hr>
            </div>
        </div>
        ...
        <div class="row form-group">
            <div class="col-12">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_1" class="custom-control-input" name="ptc12_05_01" value="Y">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_2" class="custom-control-input" name="ptc12_05_02" value="Y">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_3" class="custom-control-input" name="ptc12_05_03" value="Y">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_4" class="custom-control-input" name="ptc12_05_04" value="Y">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_5" class="custom-control-input" name="ptc12_05_05" value="Y">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-2_6" class="custom-control-input" name="ptc12_05_06" value="Y">
                        <label class="custom-control-label" for="chk-a12-2_6">อื่น ๆ (ระบุ) (Other, please specify)</label>
                    </div>
                    <input type="text" class="form-control form-control-sm mb-3" name="ptc12_05_06_sub" value=" "  >
                </div>
                <hr>
            </div>
        </div>
        ...
        <div class="row form-group">
            <div class="col-12">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-3_1" class="custom-control-input" name="ptc12_06_01" value="Y">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-3_2" class="custom-control-input" name="ptc12_06_02" value="Y">
                ...
                <div class="pl-4">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a12-3_3" class="custom-control-input" name="ptc12_06_03" value="Y">
                        <label class="custom-control-label" for="chk-a12-3_3">อื่น ๆ (ระบุ) (Other, please specify)</label>
                    </div>
                    <input type="text" class="form-control form-control-sm mb-3" name="ptc12_06_03_sub" value=" "  >
                </div>
            </div>
        </div>
