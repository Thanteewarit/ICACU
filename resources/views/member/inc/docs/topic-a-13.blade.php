...
<form class="box-topic" id="Protocol_opic13">
        ...
        <div class="topic">
            ...
            <div class="row form-group">
                <div class="col-12">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a13-1_0" class="custom-control-input" name="ptc13_01" value="Y">
                    ...
                    <div class="pl-4">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-1_1" class="custom-control-input" name="ptc13_02" value="Y">
                            <label class="custom-control-label" for="chk-a13-1_1">มีการควบคุมอุณหภูมิ (Temperature control)</label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-1_2" class="custom-control-input" name="ptc13_03" value="Y">
                            <label class="custom-control-label" for="chk-a13-1_2">มีการระบายอากาศเพียงพอ (Appropriate Ventilation)</label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-1_3" class="custom-control-input"  name="ptc13_04" value="Y">
                            <label class="custom-control-label" for="chk-a13-1_3">มีการป้องกันการติดเชื้อ (Prevent known/unknown infection)<label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-1_4" class="custom-control-input"  name="ptc13_05" value="Y">
                        ...
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-1_5" class="custom-control-input"  name="ptc13_06" value="Y">
                        ...
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-1_6" class="custom-control-input" name="ptc13_07" value="Y">
            ...
            <div class="row form-group">
                <div class="col-12">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a13-2_0" class="custom-control-input" name="ptc13_08" value="Y">
                    ...
                    <div class="pl-4">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-2_1" class="custom-control-input" name="ptc13_09" value="Y">
                            <label class="custom-control-label" for="chk-a13-2_1">มีการควบคุมอุณหภูมิ (Temperature control)</label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-2_2" class="custom-control-input" name="ptc13_10" value="Y">
                            <label class="custom-control-label" for="chk-a13-2_2">มีการระบายอากาศเพียงพอ (Appropriate Ventilation)</label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-2_3" class="custom-control-input" name="ptc13_11" value="Y">
                            <label class="custom-control-label" for="chk-a13-2_3">มีการป้องกันการติดเชื้อ (Prevent known/unknown infection)<label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-2_4" class="custom-control-input" name="ptc13_12" value="Y">
                        ...
                        <input type="text" class="form-control form-control-sm mb-3" name="ptc13_12_sub" >
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-2_5" class="custom-control-input" name="ptc13_13" value="Y">
                        ...
                        <input type="text" class="form-control form-control-sm mb-3" name="ptc13_13_sub" >
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-2_6" class="custom-control-input" name="ptc13_14" value="Y">
            ...
            <div class="row form-group">
                <div class="col-12">
                    <div class="custom-control custom-checkbox mb-1">
                        <input type="checkbox" id="chk-a13-3_0" class="custom-control-input" name="ptc13_15" value="Y">
                        <label class="custom-control-label" for="chk-a13-3_0"><strong>13.3</strong> อื่นๆ โปรดระบุ</label>
                    </div>
                    <div class="pl-4">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-3_1" class="custom-control-input" name="ptc13_16" value="Y">
                            <label class="custom-control-label" for="chk-a13-3_1">มีการควบคุมอุณหภูมิ (Temperature control)</label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-3_2" class="custom-control-input" name="ptc13_17" value="Y">
                            <label class="custom-control-label" for="chk-a13-3_2">มีการระบายอากาศเพียงพอ (Appropriate Ventilation)</label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-3_3" class="custom-control-input" name="ptc13_18" value="Y">
                            <label class="custom-control-label" for="chk-a13-3_3">มีการป้องกันการติดเชื้อ (Prevent known/unknown infection)<label>
                        </div>
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-3_4" class="custom-control-input" name="ptc13_19" value="Y">
                        ...
                        <input type="text" class="form-control form-control-sm mb-3" name="ptc13_19_sub">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-3_5" class="custom-control-input" name="ptc13_20" value="Y">
                        ...
                        <input type="text" class="form-control form-control-sm mb-3" name="ptc13_20_sub">
                        <div class="custom-control custom-checkbox mb-1">
                            <input type="checkbox" id="chk-a13-3_6" class="custom-control-input" name="ptc13_21" value="Y">
