    ...
    <div class="topic">
        ...
        <div class="row form-group">
            <div class="col-12">
                ...
                <textarea class="form-control form-control-sm" rows="3" name="Replacement01" required></textarea>
            </div>
        </div>
        <div class="row form-group">
            <div class="col-12">                        
                ...
                <textarea class="form-control form-control-sm" rows="3" name="Replacement02" required></textarea>
            </div>
        </div>
        <div class="row form-group">
            <div class="col-12">
                <label><strong>9.3</strong> ท่านมีวิธีในการปฏิบัติกับสัตว์ทดลองอย่างไร เพื่อให้สัตว์เจ็บปวดน้อยที่สุด (Refinement)</label>
                <textarea class="form-control form-control-sm" rows="3" name="Replacement03" required></textarea>
            </div>
        </div>
