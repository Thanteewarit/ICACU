    ...
    <div class="topic">
        ...
        <div class="row form-group">
            <div class="col-12 mb-4">
                ...
                <textarea class="form-control form-control-sm" name="ptc28_01" rows="3" ></textarea>
            </div>
            <div class="col-12 mb-4">
                ...
                <textarea class="form-control form-control-sm" name="ptc28_02" rows="3" ></textarea>
            </div>
            <div class="col-12 mb-4">
                ...
                <textarea class="form-control form-control-sm" name="ptc28_03" rows="3" ></textarea>
            </div>
        </div>
