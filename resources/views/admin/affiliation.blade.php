    ...
    <div class="page-wrapper">
        ...
        <div class="md-modal md-effect-2" id="modal-2">
            <div class="md-content">
                <h3>สังกัด</h3> 
                <div class="contents">
                    <form class="form-horizontal" method="POST" action="{{ route('admin.affiliationAdd') }}">
                        {{ csrf_field() }}
                        <div class="form-group row">
                            <label class="col-sm-3 col-form-label">ประเภทสังกัด</label>
                            <div class="col-sm-9">
                                <select name="affiliation_type_id" class="form-control affiliation_type_id" required>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body contents">
                        <div class="card-block">
                            <form class="form-horizontal" method="POST" action="{{ route('admin.affiliationEdit') }}">
                                {{ csrf_field() }}
                                <div class="card-block">
                                        <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">ประเภทสังกัด</label>
...
<script>
    ...
    function editRegister(id) {
        ...
        $.ajax({
            url: "{{ route('admin.affiliationGet') }}",
            data: {
                "_token": "{{ csrf_token() }}",
                'id': id
            },
            ...
            success: function (data) {
                ...
                $(".affiliation_type_id").val(obj.Affiliation.affiliation_type_id);
                $(".name").val(obj.Affiliation.name);
                $(".id").val(obj.Affiliation.id);
                $(".status").val(obj.Affiliation.status);
            }
        });
    }
